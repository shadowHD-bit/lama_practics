    ...
    <div class="auth_card">
      <div class="form_content">
        <div class="auth_card_content">
          ...
          <hr class="hr_auth" />
          <!-- Error Alert -->
          <div class="error_content" id="error_content" style="width: 100%"></div>
          <!-- Form Auth -->
          ...
          <div class="btn_content">
            <div class="submit_btn">
              <button id="submit_auth" class="submit_auth">Войти</button>
            </div>
        ...
        <div class="footer_card">
          ...
          <div class="footer_text_content">
            <span>
              <p>
                Для того, чтобы получить доступ к этой системе, обратитесь к
                администратору сайта или директору компании!
              </p>
            </span>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="border: none">
        ...
        <div class="modal-body" style="
            ...
            ">
          <p>
            Если вы забыли пароль от своей учетной записи, то вам необходимо
            обратиться к администратору сайта или вашему техническому
            директору.
          </p>
          <hr class="hr_auth" />
          <p>Контакты:</p>
