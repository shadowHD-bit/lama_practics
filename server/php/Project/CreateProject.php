...
$insertProject = $mysqlConnectForQuery->query("INSERT INTO `$projectTable` (id_status, project_deadline, project_name,  project_description) VALUES (1, '$sqldate', '$_titleProject',  '$_descriptionProject')");
